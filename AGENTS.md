...
| Client-folded Usage periods, the `usage_period` IPC operation, and the device-only budget | `docs/decisions/0032-a-period-is-folded-where-its-days-already-are.md` |
