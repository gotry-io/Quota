...
import { PROVIDER_IDS, ProviderIdSchema, type ProviderId } from "./provider-ids.generated.ts";

export { PROVIDER_IDS, ProviderIdSchema, type ProviderId };
...
export const QuotaWindowSchema = z
  .object({
    ...
    /** Absolute remaining when known (e.g. USD balance). Does not replace used_percent. */
    remaining_value: z.number().finite().optional(),
    /** Absolute limit/budget when known. */
