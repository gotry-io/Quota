...
Relay polls `statuspage_v2` URLs with a five-second timeout, stores last-good readings in
process memory, and answers `unknown` when a poll fails with nothing cached
