...
--route overview|settings|settings-window|settings-agents|settings-agents-codex|settings-agents-litellm-key|account|provider-codex|devices|usage|notifications|menu-bar-style|menu-bar-provider|support|diagnostics
