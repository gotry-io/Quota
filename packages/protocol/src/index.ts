...
// `model` is provider-owned opaque text. The literal "unknown" is a valid
// explicit model; only the released outbox compatibility path interprets it
// specially while draining old submissions.
