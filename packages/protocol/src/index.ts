import { z } from "zod";
// Generated by `pnpm generate:provider-catalog` from packages/provider/src/catalog.ts.
...
export const UsageSubmissionSchema = z
  .object({
    ...
    rows: z.array(UsageHourlyFactSchema).max(MAXIMUM_USAGE_ROWS_PER_SUBMISSION),
  })
  .strict()
