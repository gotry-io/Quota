...
Cursor is browser-session-only; Codex, Claude, Grok, and Kimi reuse the same allowlisted
acquisition as a fallback. QuotaBar 0.0.13 uploads its quota and Usage through managed-data v3;
