...
Xcode project. Do not add a third-party package manager. The app has no Sparkle, notification, or
analytics. App Store upload is the owner-only `ios-v*` workflow below.
