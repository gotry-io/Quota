 ...
 * with a fixed sample so the page and its share card can be looked at. All of this exists
 * only while `dev === true`: in production the port comes from Relay and this module is
 * never reached.
 */
